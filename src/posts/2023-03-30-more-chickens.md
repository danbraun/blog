...
{% blogImage filename="coop", alt="A ridiculous looking green and purple chicken coop", caption="I think it's art." %}
...
{% blogImage filename="chicken-box", alt="Chicken in a cardboard carton", caption="Happy meal?" %}
...
{% blogImage filename="final-four", alt="3 adult chickens standing in a run", caption="Some of the old guard" %}
...
{% blogImage filename="red-chick", alt="A Rhode Island Red chick", caption="A Rhode Island Red chick" %}