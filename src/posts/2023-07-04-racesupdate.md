...
Starting in June I train with a group of runners who are all training for the [Madison Mini half marathon](https://madisonminimarathon.com/). We meet every Wednesday and Saturday.
...
{% blogImage filename="dan-run-madtown", alt="Blog author running in front of the Madison Square", caption="Run Madtown, entering State Street and heading towards the finish." %}
...
{% blogImage filename="dan-in-eagle-chase", alt="Blog author running in Eagle Chase race on a paved path between picnic tables and trash cans", caption="Near the finish at Eagle Chase" %}
