...
{{ figure("wind-bubbles", "Man demonstrating how to mount windguards onto microphones", "Man demonstrating how to mount windguards onto microphones") }}
...
{{ figure("rockisland", "Sunrise on Rock Island", "Sunrise on Rock Island") }}
