...
{% blogImage filename="wind-bubbles", alt="Man demonstrating how to mount windguards onto microphones", caption="Man demonstrating how to mount windguards onto microphones" %}
