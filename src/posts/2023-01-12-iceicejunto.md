...
{{ figure("bitwig-sampler-layers", "Bitwig screenshot", "This is how I set up one of the samplers in Bitwig to play back samples of ice clanking glass") }}
...
{{ figure("stepic-vst","Stepic VST screenshot","Stepic VST plugin") }}
...
{{ figure("bitwig-drone-sampler","Bitwig sampler screenshot","Bitwig sampler in textures mode") }}
